public class EjemploStringMetodos {
    public static void main(String[] args) {
        ...
        System.out.println("nombre.equals(\"Eliza\") = " + nombre.equals("Eliza"));
        System.out.println("nombre.equals(\"eliza\") = " + nombre.equals("eliza"));
        System.out.println("nombre.equalsIgnoreCase(\"eliza\") = " + nombre.equalsIgnoreCase("eliza"));
        System.out.println("nombre.compareTo(\"Eliza\") = " + nombre.compareTo("Eliza"));
